...
export const ClassCardItem = ({ classItem, compact = false, instanceId }: Props) => {
    ...
    return (
        <Card
            ...
            id={classItem.id}
            type={"class"}
            classItems={classItem.content}
            previewImage={classItem.previewImage}
            titleImage={classItem.titleImage}
            title={classItem.title}
            updatedAt={classItem.updatedAt}
            status={classItem.status}
            synopsis={classItem.synopsis}
            isDragging={false}
        ></Card>
    );
    ...
    //                             <div
    //                                 key={c.id}
    //                                 className={cn("flex items-center border border-red-900 gap-2 p-2", "rounded-lg bg-white/5 border border-white/10")}
    //                             >
    //                                 <img
    //                                     src={c.previewImage}
    //                                     alt={c.title}
